...
function socialIcon(label: string) {
  const path = socialPath(label)
  return path ? <SocialIcon d={path} /> : <MailSocialIcon />
}
...
function phoneNumberToTelHref(value: string) {
...
export default async function Footer() {
  const [categories, cmsLayout, contactDetails] = await Promise.all([
